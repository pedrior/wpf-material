...
public class SheetPresenter : FrameworkElement
{
    ...
    private void CreateContainerBindings(Sheet sheet)
    {
        ...
        SetContainerBinding(sheet, ShapeAssist.FamilyProperty);
        SetContainerBinding(sheet, ShapeAssist.StyleProperty);
        SetContainerBinding(sheet, ShapeAssist.CornerProperty);
        SetContainerBinding(sheet, ShapeAssist.RadiusProperty);
        SetContainerBinding(sheet, ShapeAssist.UseStyleOnRadiusOverrideProperty);
        SetContainerBinding(sheet, ShapeAssist.UseCornersOnRadiusOverrideProperty);
        SetContainerBinding(sheet, ElevationAssist.LevelProperty);
    }
