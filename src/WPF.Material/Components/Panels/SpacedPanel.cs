...
public class SpacedPanel : Panel
{
    ...
    /// <summary>
    /// Gets or sets the spacing between children. The default value is 0.0.
    /// </summary>
    [Bindable(true)]
    ...
    /// <summary>
    /// Gets or sets the orientation of the panel. The default value is <see cref="Orientation.Horizontal"/>.
    /// </summary>
    [Bindable(true)]
    [Category(UICategory.Layout)]
    ...
    /// when the <see cref="Spacing"/> between items is 0.0. This makes the items appear separated by a single border
    /// instead of borders around each item. The default value is <see langword="false"/>.
    /// </summary>
    [Bindable(true)]
    [Category(UICategory.Layout)]
    ...
    /// <summary>
    /// Gets or sets a uniform thickness of the border around each item. This value is used when the items are
