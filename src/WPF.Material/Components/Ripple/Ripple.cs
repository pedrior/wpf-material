...
public class Ripple : ContentControl
{
    ...
    /// <summary>
    /// Gets or sets the trigger mode that determines when the ripple effect should be started.
    /// </summary>
    [Bindable(true)]
    ...
    /// <summary>
    /// Gets or sets the release mode that determines when the ripple effect should be released.
    /// </summary>
    [Bindable(true)]
    [Category(UICategory.Common)]
    ...
    /// <summary>
    /// Gets or sets a value indicating whether the ripple effect should be animated. If this property is set to
    /// <see langword="false"/>, the ripple effect will not be shown.
    /// </summary>
    [Bindable(true)]
    [Category(UICategory.Common)]
    ...
    /// will be started at the mouse position relative to this element.
    /// </summary>
    [Bindable(true)]
    [Category(UICategory.Common)]
    ...
    /// <summary>
    /// Gets or sets a <see cref="Geometry"/> that defines the outline geometry of the ripple effect.
    /// </summary>
